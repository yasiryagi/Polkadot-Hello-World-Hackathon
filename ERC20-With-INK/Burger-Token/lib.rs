...
mod burger {
    ...
    mod tests {
        ...
        type Event = <Burger as ::ink_lang::BaseEvent>::Type;
        ...
        fn assert_transfer_event(
            ...
            let expected_topics = vec![
                encoded_into_hash(b"Burger::Transfer"),
